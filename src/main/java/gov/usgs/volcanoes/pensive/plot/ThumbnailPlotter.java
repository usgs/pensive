...
/**
 * A concteate plotter to create thumbnail images without decoration.
 * 
 * @author Tom Parker
 */
public class ThumbnailPlotter extends ChannelPlotter {
   ...
   * 
   * @param spectrogramRenderer my SpectrogramRenderer
   */
   ...
   * 
   * @param waveRenderer my WaveRenderer
   */
  @Override
   ...
   * 
   * @param textRenderer My text renderer
   */
